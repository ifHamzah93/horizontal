                     ...
                     <div class="col-lg-4 col-md-7 col-sm-12">
                        <nav aria-label="breadcrumb" class="text-right">
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Blog Detail right</li>
                           </ol>
                        </nav>
                     </div>
                  </div>
   ...
   <div class="iq-blogdetailbox">
      <div class="container">
         <div class="row">
               ...
               <div class="iq-blogbox">
                  ...
                  <div class="blog-commentbox">
                     <div class="media info-block">
                        <img class="mr-3" src="{{ URL::asset('review/01.jpg') }}" alt="Generic placeholder image">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 re-mtb-30">
