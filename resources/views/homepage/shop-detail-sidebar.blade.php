...
<div class="main-content particles position-relative">
   ...
   <section class="iq-shopdetail-box left-box" data-twttr-rendered="true" data-spy="scroll" data-target=".bs-docs-sidebar">
      <div class="container">
         <div class="row">
            <div class="col-lg-3 col-md-12 col-sm-12">
               <!-- /Brand Start-->
               <div class="product-box recent-box">
            ...
            <div class="col-lg-9 col-md-12 re-mtb-30">
               <div class="row">
                  <div class="col-lg-5 col-md-5 col-sm-12">
                     <div class="iq-slick">
                        <div class="slider slider-for">
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/01.jpg') }}"></div>
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/02.jpg') }}"></div>
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/03.jpg') }}"></div>
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/04.jpg') }}"></div>
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/02.jpg') }}"></div>
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/01.jpg') }}"></div>
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/02.jpg') }}"></div>
                           <div><img class="img-fluid" alt="#" src="{{ URL::asset('images/thumb/03.jpg') }}"></div>
                  ...
                  <div class="col-lg-7 col-md-7 col-sm-12 position-relative">
                     <div class="iq-shopdetail">
                        <div class="detail-top">
                           ...
                           <p>Pri quas audiam virtute ut, case utamur fuisset eam ut, iisque accommodare an eam. Reque blandit qui eu, cu vix nonumy volumus. Legendos intellegam id usu.</p>
                        </div>
   ...
   <div class="row">
         ...
         <div class="iq-productbox">
            <div class="shopping-body">
               <div class="product-image">
                  <img class="hover" src="{{ URL::asset('images/product/01.jpg') }}" alt="product image">
               </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
         <div class="iq-productbox">
            <div class="shopping-body">
               <div class="product-image">
                  <img class="hover" src="{{ URL::asset('images/product/02.jpg') }}" alt="product image">
               </div>
               <ul class="product-icon">
                  <li><a href="#"><i class="fa fa-cart-plus" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
         <div class="iq-productbox">
            <div class="shopping-body">
               <div class="product-image">
                  <img class="hover" src="{{ URL::asset('images/product/03.jpg') }}" alt="product image">
               </div>
               <ul class="product-icon">
                  <li><a href="#"><i class="fa fa-cart-plus" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
         <div class="iq-productbox">
            <div class="shopping-body">
               <div class="product-image">
                  <img class="hover" src="{{ URL::asset('images/product/04.jpg') }}" alt="product image">
               </div>
               <ul class="product-icon">
                  <li><a href="#"><i class="fa fa-cart-plus" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
